...
function NavigationMenu({
  ...
  return (
    ...
    >
      {children}
      {viewport && <NavigationMenuViewport className="bg-background" />}
    </NavigationMenuPrimitive.Root>
  );
}
